...
If available, reserve (deduct) stock 
If not, reject the order with proper reasons
Sample Input Data:
Order Data:
{
  "items": [
...
To the above problem statement create a function to filter products that are in stock and out of stock.

Create decorator that:
Logs inputs 
Logs outputs 
Returns structured dict


Create a function to generate the same coupon code for all users using map and lambda functions.
